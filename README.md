Here’s your updated **README.md** with improved structure, modern usage example (based on your `App.tsx`), and clarified instructions for Turborepo or React Native monorepo setups:
